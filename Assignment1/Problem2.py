...
################Tableau Public URL###################
logging.info('Data Visualizations for the year 2003 can be viewed at the following URL')
logging.info('https://public.tableau.com/profile/publish/ADSTeam9Assignment1/Dashboard1')
############ EOF ############